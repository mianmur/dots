...
let g:colors_name = 'tropical'
" }}}
" Configuration: {{{
let s:configuration = {}
let s:configuration.palette = get(g:, 'terra_palette', 'soft')
let s:configuration.transparent_background = get(g:, 'terra_transparent_background', 0)
let s:configuration.disable_italic_comment = get(g:, 'terra_disable_italic_comment', 0)
let s:configuration.enable_italic = get(g:, 'terra_enable_italic', 0)
...
let s:palette = {
      ...
      \ 'bg1':        ['#1b1b1b',   '236',  'DarkGrey'],
      \ 'bg2':        ['#1b1b1b',   '237',  'DarkGrey'],
      \ 'bg3':        ['#1b1b1b',   '238',  'DarkGrey'],
      \ 'bg4':        ['#0f0f0f',   '239',  'Grey'],
      \ 'bg_red':     ['#e182a9',   '52',   'DarkRed'],
      \ 'bg_green':   ['#a9e182',   '22',   'DarkGreen'],
      \ 'bg_blue':    ['#82a9e1',   '17',   'DarkBlue'],
      \ 'fg':         ['#f0f0f0',   '223',  'White'],
      \ 'red':        ['#e182a9',   '167',  'Red'],
      \ 'orange':     ['#e182a9',   '208',  'Red'],
      \ 'yellow':     ['#e1b982',   '214',  'Yellow'],
      \ 'green':      ['#a9e182',   '108',  'Green'],
      \ 'cyan':       ['#82e1b9',   '108',  'Cyan'],
      \ 'blue':       ['#82a9e1',   '109',  'Blue'],
      \ 'purple':     ['#b982e1',   '175',  'Magenta'],
      \ 'grey':       ['#3b3b3b',   '245',  'LightGrey'],
      \ 'light_grey': ['#3b3b3b',   '245',  'LightGrey'],
      \ 'gold':       ['#e1b982',   '214',  'Yellow'],
      \ 'none':       ['NONE',      'NONE', 'NONE']
      \ }
" }}}
" Function: {{{
